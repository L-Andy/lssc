...
const VipButton: React.FC<VipButtonProps> = ({ children, disabled = true, onClick }) => {
  return (
    <button
      disabled={disabled}
      onClick={onClick}
      className="relative flex flex-col items-center cursor-pointer justify-center w-32 h-32 bg-transparent border-none outline-none"
